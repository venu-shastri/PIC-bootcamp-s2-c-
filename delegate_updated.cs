...
namespace WhyFunctionPointers
{
    ...
    public delegate void ParameterizedThreadStartCommand(object argument);
    ...
    */
    public class Thread {
        ...
        ParameterizedThreadStartCommand _parameterizedStartCommand;
        public Thread(ThreadStartCommand startCommand)
        {
            this._startCommand = startCommand;
        }
        public Thread(ParameterizedThreadStartCommand startCommand)
        {
            this._parameterizedStartCommand = startCommand;
        }
        public void Start() {
        ...
        {
            this._parameterizedStartCommand.Invoke(parameter);
        }
        public void Stop() { }
    }
